...
Week 7 finalised the evaluation of the system’s security and performance characteristics by integrating auditing, monitoring, and performance analysis into a single assessment. The security audit confirmed that implemented controls functioned as intended, while performance testing demonstrated that the hardened configuration maintained efficient operation under load. This confirmed that core security measures introduced minimal performance overhead and did not compromise system responsiveness.

The analysis highlighted key trade-offs between security and performance, reinforcing the importance of selecting proportionate controls aligned with the system’s intended role. The use of a reusable security verification script alongside automated performance benchmarking reflects real-world administrative practices and demonstrates learning beyond the minimum coursework requirements. Overall, this final evaluation showed a balanced and systematic understanding of how security, performance, and reliability interact within a production Linux server environment, meeting the intended learning outcomes of the module.
